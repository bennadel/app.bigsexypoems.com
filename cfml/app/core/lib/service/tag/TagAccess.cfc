component {
	...
	property name="tagValidation" ioc:type="core.lib.model.tag.TagValidation";
	...
	*/
	public struct function getContext(
		...
		var tag = tagModel.get( tagID );

		var context = {
			authContext,
			tag,
			...getContextForParent( authContext, tag.userID )
		};
	...
	*/
	private void function throwNotFoundError() {
		...
		tagValidation.throwNotFoundError();
	...
	*/
	private void function throwForbiddenError() {
		...
		tagValidation.throwForbiddenError();
