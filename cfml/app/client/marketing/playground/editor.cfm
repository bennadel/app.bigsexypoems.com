<cfscript>
	...
	request.response.activeNav = "playground";
	...
	*/
	private string function getDefaultPoem() {
		...
		var lines = [
			...
			"",
			"... Rhymes, Synonyms, and Definitions can be searched below #canonicalize( '&##x2193;', true, true )#"
		];
